# Amornchot PetClinic Sample Application [![Java CI with Maven](https://github.com/richieuw/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/richieuw/spring-petclinic/actions/workflows/maven.yml)
